...
export const MessageComponent = (props: any) => {
    ...
    useEffect(() => {
        if (!props.new) {
            const q = query(collection(db, "counters", props.data.id, "likes"));
    ...
    const renderEnd = () => {
        switch (props.type) {
            // text
            case 0:
                return <Text>at the world.</Text>;
            // picture
            case 1:
                return <Text>for the world.</Text>;
            // video
            case 2:
                return <Text>with the world.</Text>;
            case 3:
                return <Text>to the world.</Text>;
        }
    };
        ...
        <>
            <Pressable onPress={handleNavigate} disabled={!props.enabled}>
                <Animated.View style={[styles.container]}>
                    ...
                    <View style={{ marginLeft: 8 }}>{renderEnd()}</View>
