    ...
    <>
      <SafeAreaView style={[styles.container]}>
        ...
        >
          ...
          >
            <Text style={{ fontSize: 16, color: disabled ? "grey" : "white" }}>
              Post
            </Text>
          </Pressable>
        </View>
        ...
        >
          <Text style={{ color: "lightgrey", fontSize: 24, marginBottom: 5 }}>
            Preview:
          </Text>
          ...
          <View style={{ flex: 1 }}>
            ...
            />
            <Text style={[styles.header, { marginTop: 50, marginBottom: 5 }]}>
              Tags:
            </Text>
