...
const TextPost = ({ navigation, tags, setTags, content, setContent, handlePost }) => {
    ...
    return (
        ...
        <SafeAreaView style={[styles.container]}>
            ...
            >
                ...
                {/* render content here */}
                <View style={{ flex: 1 }}>
                    <MessageComponent enabled={false} data={dummyData} state={0} navigation={navigation} tags={tags} new/>
